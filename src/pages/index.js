  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark min-h-screen">
        <Layout clasName="pt-0">
          <div className="flex items-center justify-between w-full">
            <div className="w-1/2">
              <Image src={profilePic} alt="Monojit" className="w-full h-auto" />
            </div>
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <div className="flex items-center self-start mt-2">
                ...
                <Link href="mailto:tewarimonojit@gmail.com" target={"_blank"}
        ...
        w-24
        ">
          <Image src={lightBulb} alt="Monojit" className="w-full h-auto"/>
        </div>
      </main>
    </>
  );
